...
const ListSection = () => {
  return (
    <div className="bg-[#151414] text-white p-4 rounded-xl mt-0 h-[20vh] sm:h-[40vh] border border-[#484848] md:h-[30vh] lg:h-[40vh] overflow-y-auto flex flex-col items-center justify-between">
